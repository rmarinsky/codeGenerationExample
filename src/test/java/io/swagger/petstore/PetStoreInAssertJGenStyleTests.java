...
public class PetStoreInAssertJGenStyleTests {
    ...
    void createAndGetPet() {
        ...
        PetAssert.assertThat(pet.as(Pet.class)).hasId(targetPet.getId());

        var petById = petController.getPetById(targetPet.getId().toString());

        PetAssert.assertThat(petById.as(Pet.class)).isEqualTo(targetPet);
